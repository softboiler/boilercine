...
from boilercine_docs import DOCS, PYPROJECT, chdir_docs
from boilercine_docs.intersphinx import get_ispx, get_rtd, get_url
from boilercine_docs.types import IspxMappingValue
